...
function handleLanguageChange() {
  ...
  console.log('Language changed to:', langMap[selectedLanguage.value])
}
</script>
  ...
  <div class="auth-page" v-cloak>
    <div class="left-panel">
      ...
      <h1 class="welcome-title">
        {{ isForgotPasswordMode ? 'Reset Password' : (isSignUpMode ? 'Create Account' : 'Welcome!') }}
      </h1>
      <p class="welcome-subtitle">
        {{
          isForgotPasswordMode
            ...
            : (isSignUpMode
              ? 'Sign up to get started with Spotify.'
              : 'Log in to Spotify to continue to Spotify.')
        }}
      </p>
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper password-wrapper">
            <input
              ...
              :placeholder="isSignUpMode ? 'Create a password' : 'Your password'"
    ...
    <div class="right-panel">
      <div class="language-selector">
        <select v-model="selectedLanguage" class="lang-select" @change="handleLanguageChange">
      ...
      <div class="scene-container">
        ...
        <h2 class="secondary-title">Define The True Music</h2>
        <h3 class="tertiary-title">Now Try It</h3>
      </div>

      <div class="bottom-info">
        <p class="stats-text slide-up-text slide-up-text-delay-1">
          <span class="highlight">400K+</span> users.
          <span class="highlight">50M+</span> AI generated graphics.
        </p>
